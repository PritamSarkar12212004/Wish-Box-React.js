...
function Cards(props) {
  ...
  return (
    <div
      className="lg:w-60 md:w-56  w-44    relative hover:scale-105 duration-300 cursor-pointer border-[1px] border-zinc-300 rounded-lg px-3 py-2"
    ...
    >
      ...
      <div className="w-full md:h-44   md:relative -top-10 md:bg-white mt-2 md:border-[1px] md:border-zinc-300 md:shadow-md md:rounded-2xl px-2 md:py-2 ">
        ...
        <p className="text-sm md:flex hidden">{ProductDescription}</p>
