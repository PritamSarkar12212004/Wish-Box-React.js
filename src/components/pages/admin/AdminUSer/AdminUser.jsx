...
function AdminUser() {
  return (
    <div className="px-5 py-5 h-[91.8vh] flex-auto">
      <div className="bg-blue-500 text-white lg:px-5 lg:py-5 md:px-4 md:py-4 sm:px-3 sm:py-5 px-2 py-2 rounded-xl mb-5 flex  justify-between">
      ...
      <ul className="w-full flex justify-center sm:flex-col  gap-5 items-center flex-wrap">
