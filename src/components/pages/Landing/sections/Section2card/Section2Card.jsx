...
function Section2Card() {
  return (
    <div className="flex w-full justify-between gap-12">
      <div className="h-80 w-72 rounded-3xl bg-[#2B2B2B] relative px-3 py-3 text-white flex  items-center ">
        <h1 className=" z-20">
      ...
      <div className="h-80 w-72 rounded-3xl bg-[#FDC938] relative px-3 py-3 text-white flex  items-center ">
        <h1 className=" z-20">
          <span className="text-2xl font-bold opacity-70">Decoration</span>{" "}
          <br />
          <span className="text-3xl font-bold  opacity-80 tracking-widest">
      ...
      <div className="h-80 flex-auto rounded-3xl bg-[#F4333D] relative px-5 py-5 flex  items-center">
        <h1 className=" z-20">
