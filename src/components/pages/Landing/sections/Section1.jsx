...
function Section1() {  
  ...
  return (  
    <div  
      ref={sectionRef}  
      className="w-full h-screen bg-[#E6E8EB] rounded-3xl relative lg:px-10 lg:py-10 md:px-4 md:py-4 flex items-center overflow-hidden md:relative"  
    >  
      <img  
        src="/assets/Responsive/1.jpg"  
      ...
      />  
      <img  
        src="/assets/Responsive/mobile.jpg"  
